...
const instagramModalCloseButton = document.querySelector('#instagram-modal-close-button');
const instagramModalDeleteButton = document.querySelector('#instagram-modal-delete-button');
